---
url: "https://platform.openai.com/docs/api-reference/introduction?lang=javascript"
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/introduction?lang=javascript).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/introduction?lang=javascript).
