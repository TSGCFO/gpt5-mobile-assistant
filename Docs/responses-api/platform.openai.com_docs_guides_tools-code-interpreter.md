...
Note that containers created with the auto mode are also accessible using the [`/v1/containers`](https://platform.openai.com/docs/api-reference/containers) endpoint.
