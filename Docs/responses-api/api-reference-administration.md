<!-- Source: https://platform.openai.com/docs/api-reference/administration -->
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/administration).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/administration).
