---
url: "https://platform.openai.com/docs/api-reference/usage/costs_object?lang=javascript"
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/usage/costs_object?lang=javascript).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/usage/costs_object?lang=javascript).
