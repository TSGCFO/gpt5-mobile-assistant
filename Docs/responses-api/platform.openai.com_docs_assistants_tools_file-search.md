...
Alternatively, you can add several files to a vector store by [creating batches](https://platform.openai.com/docs/api-reference/vector-stores/createBatch) of up to 500 files.
