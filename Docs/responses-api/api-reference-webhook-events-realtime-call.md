<!-- Source: https://platform.openai.com/docs/api-reference/webhook-events/realtime/call -->
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/webhook-events/realtime).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/webhook-events/realtime).
