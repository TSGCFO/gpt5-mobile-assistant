---
url: "https://platform.openai.com/docs/api-reference/usage?lang=javascript"
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/usage?lang=javascript).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/usage?lang=javascript).
