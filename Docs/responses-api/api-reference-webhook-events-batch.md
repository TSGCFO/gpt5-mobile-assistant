<!-- Source: https://platform.openai.com/docs/api-reference/webhook-events/batch -->
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/webhook-events/batch).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/webhook-events/batch).
