---
url: "https://platform.openai.com/docs/api-reference/introduction?api-mode=responses"
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/introduction?api-mode=responses).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/introduction?api-mode=responses).
