---
url: "https://platform.openai.com/docs/api-reference/fine-tuning/checkpoint-object"
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/fine-tuning/checkpoint-object).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/fine-tuning/checkpoint-object).
