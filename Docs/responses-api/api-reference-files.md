...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/files).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/files).
