---
url: "https://platform.openai.com/docs/guides/image-generation?image-generation-model=dall-e-3"
...
DALL·E 3 is our previous generation model and has some limitations. For a better
experience, we recommend using [GPT\\
...
This guide focuses on DALL·E 3, but you can also switch to the docs for [GPT\\
Image](https://platform.openai.com/docs/guides/image-generation?image-generation-model=gpt-image-1) and [DALL·E\\
2](https://platform.openai.com/docs/guides/image-generation?image-generation-model=dall-e-2).
...
The Image Edits endpoint is not available for DALL·E 3. If you would like to edit images, we recommend using our newest model, [GPT Image](https://platform.openai.com/docs/guides/image-generation?image-generation-model=gpt-image-1).
...
|     |     |
| --- | --- |
| Available sizes | - `1024x1024` (square) - `1024x1792` (portrait) - `1792x1024` (landscape)<br>- `auto` (default) |
