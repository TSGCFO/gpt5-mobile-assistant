<!-- Source: https://platform.openai.com/docs/api-reference/graders -->
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/graders).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/graders).
