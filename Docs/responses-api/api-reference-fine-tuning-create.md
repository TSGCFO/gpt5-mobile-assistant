...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/fine-tuning/create).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/fine-tuning/create).
