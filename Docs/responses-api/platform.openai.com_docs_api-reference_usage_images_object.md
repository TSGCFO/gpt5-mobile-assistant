---
url: "https://platform.openai.com/docs/api-reference/usage/images_object"
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/usage/images_object).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/usage/images_object).
