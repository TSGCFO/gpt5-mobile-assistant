---
url: "https://platform.openai.com/docs/guides/function-calling/supported-models"
...
**Note:** Currently, if you are using a fine tuned model and the model calls multiple functions in one turn then [strict mode](https://platform.openai.com/docs/guides/function-calling/supported-models#strict-mode) will be disabled for those calls.
