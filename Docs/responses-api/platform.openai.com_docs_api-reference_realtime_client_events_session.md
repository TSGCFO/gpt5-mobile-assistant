---
url: "https://platform.openai.com/docs/api-reference/realtime_client_events/session"
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/realtime_client_events/session).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/realtime_client_events/session).
