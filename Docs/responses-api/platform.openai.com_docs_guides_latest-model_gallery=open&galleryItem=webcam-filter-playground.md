...
EffectNoneGrayscaleSepiaInvertPosterizePixelateRGB SplitEdge DetectThermal CamKaleidoscope (4-way)Wavy Warp

Amount

CaptureSave

Camera access failed. Open this page over https or localhost and allow camera permissions.

Tip: Press C to capture, S to save. Camera access requires a secure context (https or localhost). No data leaves your device.
