...
business11engineering7finance5marketing2operations3processes5product5projects5security1support4teams6

Clear

27 results

Sort byAcronym (A–Z)Term (A–Z)

API

Application Programming Interface

A set of rules for how software components interact.
...
Yearly value of recurring revenue from subscriptions.
...
The percentage of customers who stop using a product over a time period.
...
Team that assists customers with issues and questions.
...
A measure of customer satisfaction, typically collected via surveys.
...
A role responsible for the installation, configuration, and maintenance of databases.
...
A deadline indicating completion by the end of the business day.
...
The expected completion or delivery time for a task or item.
...
The plan and activities to bring a product to market.
...
Team managing hiring, compensation, and employee relations.
...
A prediction of the net profit from the entire relationship with a customer.
...
Monthly value of recurring revenue from subscriptions.
...
A version of a product with just enough features to be used and tested by early customers.
...
A metric that measures customer loyalty by asking how likely they are to recommend.
...
Goal-setting framework for aligning priorities and measuring outcomes.
...
Role accountable for product strategy, roadmap, and outcomes.
...
A small implementation to validate feasibility before full execution.
...
A document that defines a product’s purpose, features, and constraints.
...
Practices and processes for ensuring product quality and preventing defects.
...
A profitability ratio that compares gain or loss relative to cost.
...
A collection of tools, libraries, and docs for building software on a platform.
...
A commitment on service quality, uptime, or response times between teams or vendors.
...
A documented set of step-by-step instructions to carry out routine operations.
...
Engineering discipline focused on reliability and scalability of systems.
...
A system that allows users to authenticate once and access multiple applications.
...
DirectionAcronym → DefinitionDefinition → AcronymMixedQuestions51015All in poolStart Quiz
