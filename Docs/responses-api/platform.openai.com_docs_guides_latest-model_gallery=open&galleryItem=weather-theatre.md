---
url: "https://platform.openai.com/docs/guides/latest-model?gallery=open&galleryItem=weather-theatre"
...
Remix the same mock forecast into different stage sets. Parallax backdrops, spotlight sweeps, and a velvet curtain reveal. No external APIs.
...
Cosy: warmth, glow, drizzleEerie: fog, teal hazeHeroic: contrast, bold spotlights

Matinée: a warm hush beneath gentle clouds — 18°C, 12 km/h wind
