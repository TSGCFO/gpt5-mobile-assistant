---
url: "https://platform.openai.com/docs/guides/latest-model?gallery=open&galleryItem=customer-journey-flow"
...
Add StageAuto-layout

Export JSONReset

Tip: drag a handle between stages to connect. Double‑click a title to edit.

Stages are draggable. Connect with handles. Right arrow markers indicate flow direction.
