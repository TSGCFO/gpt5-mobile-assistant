...
To learn how to use the results with our models, check out the [synthesizing responses](https://platform.openai.com/docs/guides/retrieval/vector-stores#synthesizing-responses) section.
