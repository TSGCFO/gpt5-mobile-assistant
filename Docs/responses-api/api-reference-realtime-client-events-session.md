<!-- Source: https://platform.openai.com/docs/api-reference/realtime-client-events/session -->
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/realtime-client-events/session).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/realtime-client-events/session).
