...
ClearRandomizeExport WAV

Export Pattern JSONImport JSON

### About

16-step drum grid powered by WebAudio API. Drag to paint steps. Swing adds groove. Save and load patterns, or export the loop as a WAV.
