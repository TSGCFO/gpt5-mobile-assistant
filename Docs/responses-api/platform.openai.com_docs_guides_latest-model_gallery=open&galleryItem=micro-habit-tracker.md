---
url: "https://platform.openai.com/docs/guides/latest-model?gallery=open&galleryItem=micro-habit-tracker"
...
Jump to TodayClear selected day

Tip: Tap a date header to select it. Toggle checkboxes to mark done. Use ⏭️ Skip day if life happens — your streaks will not break.
