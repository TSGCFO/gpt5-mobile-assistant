<!-- Source: https://platform.openai.com/docs/api-reference/run-steps -->
...
**NOTE:** This endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/run-steps).
...
**NOTE:** Calling this endpoint requires an [admin API key](https://platform.openai.com/docs/api-reference/run-steps).
