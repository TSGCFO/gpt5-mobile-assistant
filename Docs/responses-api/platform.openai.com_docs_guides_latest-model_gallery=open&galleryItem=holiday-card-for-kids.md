---
url: "https://platform.openai.com/docs/guides/latest-model?gallery=open&galleryItem=holiday-card-for-kids"
...
Happy Holidays! - Playful Card

❄️Happy Holidays!✨

Play JingleMusic: OffSound: OnResetRandomize

Tip: Drag stickers in, pinch/scroll to resize, double-tap to flip!
...
Drag stickers into the snowy scene. Click items for surprises. Wheel/Pinch to resize, double-click to flip. Have fun! ❄️
