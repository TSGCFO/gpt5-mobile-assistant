---
url: "https://platform.openai.com/docs/guides/latest-model?gallery=open&galleryItem=ocean-wave-simulation"
...
Tip: drag the sliders and relax. Lighting blends from night (0) to noon (1).
