---
url: "https://platform.openai.com/docs/guides/latest-model?gallery=open&galleryItem=brutalist-dev-landing-page"
...
# Ship APIs at terminal velocity.

Monochrome. Minimal. Maximum throughput for devs who hate waiting.


[Start free](https://gpt5-coding-examples.vercel.app/brutalist-dev-landing-page#) [Docs](https://gpt5-coding-examples.vercel.app/brutalist-dev-landing-page#docs)
...
```
const res = await api.query("items")
  .where({ tier: "pro" })
  .limit(10)
  .run()
```
...
| Tier | Included | Limits | Price | Action |
| --- | --- | --- | --- | --- |
| Free | Core APIs, 1 project | 10k requests/mo | $0 | Choose |
| Pro | Everything in Free, 10 projects, metrics | 1M requests/mo | $29 | Choose |
| Enterprise | SAML SSO, dedicated region, support | Custom | Contact | Contact |
